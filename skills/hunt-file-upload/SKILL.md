...
description: "Hunt file-upload bugs including webshell RCE, SVG or HTML XSS, XXE in document processors, path traversal, double extensions, magic-byte spoofing, null-byte and case bypasses, server configuration uploads, ZIP slip, and polyglots. Use for upload, avatar, attachment, import/export, XML, DOCX, and ZIP features; require concrete execution or impact evidence."
---
