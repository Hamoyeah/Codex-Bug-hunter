---
name: bug-bounty
description: Complete authorized bug-bounty workflow covering scope, recon, attack-surface analysis, web and API vulnerability hunting, source review, AI security testing, exploit chaining, validation gates, CVSS, and platform-ready reports. Use when starting a target, testing a bug class, auditing code, validating a finding, or drafting a report.
---
