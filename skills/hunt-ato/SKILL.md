---
name: hunt-ato
description: "Hunt account-takeover paths and chains across password reset, email change, OAuth linking, MFA, sessions, JWTs, step-up checks, recovery questions, and SSO redirect domains. Use when testing ATO primitives or validating a real takeover of an owned test account without harming other users."
---
