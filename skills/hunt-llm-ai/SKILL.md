---
name: hunt-llm-ai
description: "Hunt authorized LLM and agentic-AI security issues including direct or indirect prompt injection, tool-use exfiltration, ASCII smuggling, markdown exfiltration, system-prompt leaks, cross-tenant IDOR, RAG flaws, and unsafe MCP tools. Require reproducible evidence; model confabulation alone is not a finding."
---
